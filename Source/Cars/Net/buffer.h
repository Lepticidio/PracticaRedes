...
public:
  ...
  void write(int _data) { write(&_data, sizeof(_data)); }
  void write(size_t _data) { write(&_data, sizeof(_data)); }
  void write(float _data) { write(&_data, sizeof(_data)); }
  void write(unsigned int _data) { write(&_data, sizeof(_data)); }
  ...
  void read(int& data_) { read(&data_, sizeof(data_)); }
  void read(size_t& data_) { read(&data_, sizeof(data_)); }
  void read(float& data_) { read(&data_, sizeof(data_)); }
  void read(unsigned int& data_) { read(&data_, sizeof(data_)); }
	void read(char* data_);
