...
public:
	void SetTrapPosition(FVector _vTrapPosition) { m_vTrapPosition = _vTrapPosition; m_bSendCommand = true; SerializeData(); }
	void SetSendCommand(bool _bNewValue) { m_bSendCommand = _bNewValue; }
};
